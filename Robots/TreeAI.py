...
class TreeAI:
    ...
    def decide_move(self, board, me, players, mid_card):
        ...
        new_board_states = self.get_new_board_states(board, me, players, mult, mid_card)

        for i in range(0, len(new_board_states)):
            new_board_state = new_board_states[i]
            points = self.minimax(self.depth - 1, new_board_state, -math.inf, math.inf, False)
    ...
    def get_new_board_states(self, board, me, players, mult, mid_card):
        board_states = []
